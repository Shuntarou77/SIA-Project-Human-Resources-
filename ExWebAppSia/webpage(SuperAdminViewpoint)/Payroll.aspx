<%@ Page Title="Payroll Management" Language="C#" MasterPageFile="~/webpage(SuperAdminViewpoint)/SuperAdmin.Master" AutoEventWireup="true"
    CodeBehind="Payroll.aspx.cs" Inherits="ExWebAppSia.webpage_SuperAdminViewpoint_.WebForm6" Async="true" Culture="en-US" UICulture="en-US"
    %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div id="payroll-gen" class="tab-content active">
                                ...
                                <div
                                    ...
                                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                                        ...
                                        <span id="totalAllowancesDisplay"
                                            style="font-weight:700; color:var(--primary-burgundy);">â‚±0.00</span>
                                    </div>
                                    <div style="display:flex; justify-content:space-between;">
                                        <span style="font-weight:700; font-size:16px;">Gross Monthly Salary:</span>
                                        <span id="grossMonthlySalaryDisplay"
                                            style="font-weight:700; font-size:18px; color:var(--primary-burgundy);">â‚±0.00</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                                        ...
                                        <span id="totalStatutoryDeductionsDisplay"
                                            style="font-weight:700; color:#991B1B;">â‚±0.00</span>
                                    </div>
                                    <div style="display:flex; justify-content:space-between;">
                                        <span style="font-weight:700; font-size:16px;">Total Loan Deductions:</span>
                                        <span id="totalLoanDeductionsDisplay"
                                            style="font-weight:700; font-size:16px; color:#991B1B;">â‚±0.00</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="payslipModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div style="text-align:center; margin-bottom:20px; color:#666;" id="payslipPeriod">Jan 1â€“15,
                            2025</div>
                ...
                <script>
                    ...
                    function nextStep(stepNumber) {
                        ...
                        // ðŸŽ¯ DYNAMIC STEP 4: Populate review table when entering Step 4
                        if (stepNumber === 4) {
                    ...
                    /**
                     * ðŸŽ¯ NEW: Populate Step 4 review table with dynamic data from Step 3
                     */
                    function populateStep4ReviewTable() {
                        console.log('ðŸŽ¨ Populating Step 4 review table...');
                        ...
                        if (!__currentPayRun || !__currentPayRun.items || __currentPayRun.items.length === 0) {
                            console.log('âŒ No payroll data available for Step 4');
                            setTimeout(() => {
                                loadingState.style.display = 'none';
                                errorState.style.display = 'block';
                            }, 500);
                        ...
                        console.log('âœ… Found payroll data:', __currentPayRun.items.length, 'employees');
        ...
        `;
                        ...
                        setTimeout(() => {
                            ...
                            console.log('âœ… Step 4 review table populated successfully');
                        }, 800); // Small delay for smooth transition
                    }

                    /**
                     * ðŸŽ¯ NEW: Toggle edit mode for gross salary in review table
                     */
                    ...
                    /**
                     * ðŸŽ¯ NEW: Update gross salary in review table and recalculate totals
                     */
                    function updateGrossInReview(input) {
                        ...
                        console.log('ðŸ’° Updating gross salary for employee', employeeId, 'to', newValue);
                        ...
                        if (__currentPayRun && __currentPayRun.items) {
                            ...
                            if (item) {
                                ...
                                console.log('ðŸ“Š Updated employee data:', {
                    ...
                    /**
                     * ðŸŽ¯ NEW: Recalculate totals in review table
                     */
                    ...
                    // ðŸŽ¯ CRITICAL FIXES: Add missing functions that are called but not defined

                    /**
                     * Update dashboard statistics (called by nextStep and other functions)
                     */
                    function updateDashboard() {
                        console.log('ðŸ“Š updateDashboard() called');

                        // Check if we have payroll data
                        if (typeof __currentPayRun === 'undefined' || !__currentPayRun) {
                            console.log('âš ï¸ No payroll data available for dashboard update');
                            return;
                        }
                        ...
                        console.log('âœ… Dashboard updated:', __currentPayRun);
                    }
                    ...
                    if (typeof generatePayroll === 'undefined') {
                        console.warn('âš ï¸ generatePayroll() not loaded from external file, using fallback');

                        function generatePayroll() {
                            console.log('ðŸš€ generatePayroll() called (fallback implementation)');
                    ...
                    function displayComputationResults(payRun) {
                        console.log('ðŸ“Š Displaying computation results...');
            ...
            `;
                        ...
                        console.log('âœ… Computation results displayed');
                    }
