<%@ Page Title="Announcement" Language="C#" MasterPageFile="~/webpage(SuperAdminViewpoint)/SuperAdmin.Master"
    AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="ExWebAppSia.webpage_SuperAdminViewpoint_.WebForm4" %>
    ...
    <div class="container-box">
        ...
        <div class="create-panel">
            <div class="create-header">
                ...
                <textarea id="txtAnnouncement" class="create-input" placeholder="What's on your mind, Super Admin?"
            ...
            container.innerHTML = filtered.map(ann => `
                <div class="announcement-card ${ann.IsPinned ? 'pinned-mode' : ''}">
                    ...
                    <div class="card-header">
                        <div class="poster-avatar">${(ann.PostedBy || 'S').charAt(0)}</div>
                        <div class="poster-info">
                            <h4>${ann.PostedBy || 'Super Admin'}</h4>
