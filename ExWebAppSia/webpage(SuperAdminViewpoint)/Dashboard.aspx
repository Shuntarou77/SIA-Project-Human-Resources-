<%@ Page Title="" Language="C#" MasterPageFile="~/webpage(SuperAdminViewpoint)/SuperAdmin.Master" AutoEventWireup="true"
    CodeBehind="Dashboard.aspx.cs" Inherits="ExWebAppSia.webpage_SuperAdminViewpoint_.WebForm1" Async="true" %>
                    ...
                    <div class="dashboard-container">
                        <div class="dashboard-upper">
                            <div class="dashboard-header">
                                ...
                                <div class="role-badge" style="display: inline-block; background: #A36A66; color: white; padding: 4px 14px; border-radius: 20px; font-size: 13px; font-weight: 700; margin-top: 10px; box-shadow: 0 4px 10px rgba(163, 106, 102, 0.2);">SUPER ADMIN | <%= GetEmployeeDepartment() %></div>
