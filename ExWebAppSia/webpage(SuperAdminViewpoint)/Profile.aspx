<%@ Page Title="HR Profile" Language="C#" MasterPageFile="~/webpage(SuperAdminViewpoint)/SuperAdmin.Master" AutoEventWireup="true" Async="true"
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="confirmModal" class="page-modal" style="display:none;">
            <div class="modal-content" style="max-width: 440px; text-align:center; padding: 0; border-radius:20px; overflow:hidden;">
            ...
            <div style="background: white; margin: 100px auto; border-radius: 20px; width: 90%; max-width: 450px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); overflow: hidden; font-family: 'Poppins', sans-serif;">
                ...
                <div id="undertimeSelection" style="padding: 30px; text-align: center;">
                    ...
                    <div style="margin-top: 15px; font-size: 12px; color: #6b7280;">
                        Already have an approved request? <a href="javascript:void(0)" onclick="undertimeYes()" style="color: #3b82f6; font-weight: 600; text-decoration: none;">Check status</a>
                    </div>
                </div>
