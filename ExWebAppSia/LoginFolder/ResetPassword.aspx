<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs"
    Inherits="ExWebAppSia.LoginFolder.ResetPassword" Async="true" %>
    ...
    <body>
        <form id="form1" runat="server">
            <div class="container">
                ...
                <p class="subtitle">Please enter your new password below. Make sure it's secure.</p>
                ...
                <div id="pnlForm" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" Required="true"
                            CssClass="form-control" placeholder="Enter new password"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Confirm Password</label>
                        <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" Required="true"
                            CssClass="form-control" placeholder="Confirm new password"></asp:TextBox>
                    </div>

                    <asp:Button ID="btnResetPassword" runat="server" Text="Update Password" CssClass="btn-reset"
