    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        private async Task InitializeDefaultUsers()
        {
            try
            {
                ...
                // ❌ DO NOT create test employee accounts with null data
                // Real employees should be created through the Recruitment -> Hire workflow
                // which properly sets all required fields (firstName, lastName, department, position, etc.)
