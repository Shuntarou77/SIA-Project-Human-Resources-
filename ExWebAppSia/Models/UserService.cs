    ...
    public class UserService
    {
        ...
        public async Task<bool> CreateUserAsync(string username, string password, string role, string email = "")
        {
            try
            {
                ...
                // For Employee role, add minimal employee fields if needed for compatibility
                if (role == "Employee")
                {
                    System.Diagnostics.Debug.WriteLine("⚠ Creating Employee login account. Actual employee data should be in Employees collection.");
                }
