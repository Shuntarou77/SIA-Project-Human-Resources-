        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="payslip-item">
                    ...
                    <span class="payslip-value" style="color: var(--warning-color);">- ₱<%= GetSSSDeduction() %></span>
                </div>
                <div class="payslip-item">
                    <span class="payslip-label">PhilHealth</span>
                    <span class="payslip-value" style="color: var(--warning-color);">- ₱<%= GetPhilHealthDeduction() %></span>
                </div>
                <div class="payslip-item">
                    <span class="payslip-label">Pag-IBIG</span>
                    <span class="payslip-value" style="color: var(--warning-color);">- ₱<%= GetPagIbigDeduction() %></span>
                </div>
                <div class="payslip-item">
                    <span class="payslip-label">Withholding Tax</span>
                    <span class="payslip-value" style="color: var(--warning-color);">- ₱<%= GetWithholdingTax() %></span>
                </div>
                <div class="payslip-item">
                    <span class="payslip-label"><strong>Total Deductions</strong></span>
                    <span class="payslip-value" style="color: var(--warning-color);"><strong>- ₱<%= GetTotalDeductions() %></strong></span>
                </div>
