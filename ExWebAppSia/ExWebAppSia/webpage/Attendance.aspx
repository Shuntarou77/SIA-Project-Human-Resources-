...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        :root {
            ...
            --panel-bg: #ffffff;
            --stat-bg: #A36A66;               /* ✅ Unified accent color */
            --text-dark: #333333;
            --text-light: #ffffff;
            --border-color: #e5e5e5;
            --hover-bg: #f9f9f9;
            --stat-hover: #905A57;            /* Slightly darker on hover */
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="attendance-container">
        ...
        <div class="header-panel">
            <div class="date-selector">
                <span class="date-text" id="dateDisplay"><%= GetDateDisplay() %></span>
                ...
                <svg class="calendar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onclick="document.getElementById('datePicker').showPicker()" style="cursor: pointer;">
    ...
    <script>
        function changeDate(days) {
            // Create a form and submit it to change the date
