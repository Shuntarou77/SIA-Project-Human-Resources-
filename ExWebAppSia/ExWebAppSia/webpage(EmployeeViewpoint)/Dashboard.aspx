...
<%@ Page Title="Employee Dashboard" Language="C#" MasterPageFile="~/webpage(EmployeeViewpoint)/EmployeeHR.Master" AutoEventWireup="true" Async="true" CodeBehind="Dashboard.aspx.cs" Inherits="ExWebAppSia.webpage_EmployeeViewpoint_.WebForm1" %>
    ...
    <div class="dashboard">
        ...
        <div class="stats-section">
            <div class="stat-card">
                ...
                <div class="stat-trend <%= GetOverallAttendanceTrendClass() %>"><%= GetOverallAttendanceChange() %></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-trend <%= GetDaysPresentTrendClass() %>"><%= GetDaysPresentChange() %></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-trend <%= GetDaysAbsentTrendClass() %>"><%= GetDaysAbsentChange() %></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-trend <%= GetDaysLateTrendClass() %>"><%= GetDaysLateChange() %></div>
            </div>
        </div>
                    ...
                    <div class="actions-section">
                        ...
                        <div class="stats-card">
                            ...
                            <div class="stats-item">
                                ...
                                <span class="stats-value"><%= GetWeekPresentDays() %></span>
                            </div>
                            <div class="stats-item">
                                <span class="stats-label">On Time</span>
                                <span class="stats-value success-value"><%= GetWeekOnTimePercent() %>%</span>
                            </div>
                            <div class="stats-item">
                                <span class="stats-label">Streak</span>
                                <span class="stats-value warning-value"><%= GetStreak() %> days</span>
                            </div>
                        </div>
                    </div>
                </div>
