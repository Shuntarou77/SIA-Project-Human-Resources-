...
<head runat="server">
    ...
    * {
    ...
    .login-container {
        ...
        border-radius: 20px;
        box-shadow: 0 10px 40px rgba(163, 106, 102, 0.15); /* ✅ Softer shadow */
        overflow: hidden;
        width: 100%;
        max-width: 400px;
    ...
    .login-header {
        background: linear-gradient(135deg, #A36A66, #C49A99); /* ✅ Brand gradient */
        padding: 40px 30px;
        text-align: center;
        color: white;
    }
    ...
    .form-control {
        width: 100%;
        padding: 14px 18px;
        border: 2px solid #F8ECEB; /* ✅ Soft neutral border */
        border-radius: 10px;
        font-size: 15px;
        transition: all 0.3s ease;
        background-color: #FCFAF9; /* Very light warm neutral */
    }
    ...
    .remember-me input[type="checkbox"] {
        ...
        height: 18px;
        cursor: pointer;
        accent-color: #A36A66; /* ✅ Brand checkbox */
    }

    .forgot-link {
        color: #A36A66; /* ✅ Brand link */
