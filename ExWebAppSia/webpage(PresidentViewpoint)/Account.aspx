        ...
        <script>
            ...
            function downloadPDF() {
                try {
                    ...
                    element.innerHTML = `
                        <div style="padding: 40px; font-family: 'Arial', sans-serif; color: #000; width: 700px; margin: auto; border: 1px solid #000;">
                            <div style="text-align: center; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 20px;">
                                <h1 style="margin: 0; font-size: 22px;">SHEESSENTIALS SKINCARE AND BEAUTY MANUFACTURING CO.</h1>
                                <p style="margin: 5px 0; font-size: 14px; font-weight: bold;">PAYSLIP</p>
                            </div>
                            
                            <table style="width: 100%; margin-bottom: 20px; font-size: 13px;">
                                <tr>
                                    <td style="width: 50%; padding: 5px;"><strong>Employee:</strong> ${name}</td>
                                    <td style="text-align: right; padding: 5px;"><strong>Pay Period:</strong> ${period}</td>
                                </tr>
                            </table>

                            <div style="display: flex; gap: 20px;">
                                <div style="flex: 1;">
                                    <h3 style="font-size: 14px; border-bottom: 1px solid #000; padding-bottom: 5px;">EARNINGS</h3>
                                    <table style="width: 100%; font-size: 12px; border-collapse: collapse;">
                                        <tr><td style="padding: 4px 0;">Basic Salary</td><td style="text-align: right;">${basic}</td></tr>
                                        <tr><td style="padding: 4px 0;">Allowances</td><td style="text-align: right;">${allowances}</td></tr>
                                        <tr><td style="padding: 4px 0;">Overtime Pay</td><td style="text-align: right;">${ot}</td></tr>
                                        <tr style="font-weight: bold; border-top: 1px solid #000;"><td style="padding: 6px 0;">GROSS PAY</td><td style="text-align: right;">${gross}</td></tr>
                                    </table>
                                </div>
                                <div style="flex: 1;">
                                    <h3 style="font-size: 14px; border-bottom: 1px solid #000; padding-bottom: 5px;">DEDUCTIONS</h3>
                                    <table style="width: 100%; font-size: 12px; border-collapse: collapse;">
                                        <tr><td style="padding: 4px 0;">Govt Deductions</td><td style="text-align: right;">${sss} / ${ph} / ${pi} / ${tax}</td></tr>
                                        <tr><td style="padding: 4px 0;">Absences & Lates</td><td style="text-align: right;">${abs}</td></tr>
                                        <tr><td style="padding: 4px 0;">Penalties</td><td style="text-align: right;">${pen}</td></tr>
                                        <tr style="font-weight: bold; border-top: 1px solid #000;"><td style="padding: 6px 0;">TOTAL DEDUCTIONS</td><td style="text-align: right;">${ded}</td></tr>
                                    </table>
                                </div>
                            </div>

                            <div style="margin-top: 20px; border: 2px solid #000; padding: 15px; text-align: center;">
                                <span style="font-size: 16px; font-weight: bold;">NET TAKE-HOME PAY: </span>
                                <span style="font-size: 20px; font-weight: bold;">${net}</span>
                            </div>

                            <div style="margin-top: 40px; display: flex; justify-content: space-between; font-size: 12px;">
                                <div style="width: 45%; text-align: center;">
                                    <div style="border-top: 1px solid #000; margin-top: 30px;">Employee Signature</div>
                                </div>
                                <div style="width: 45%; text-align: center;">
                                    <div style="border-top: 1px solid #000; margin-top: 30px;">HR Representative</div>
                                </div>
                            </div>
            ...
            function downloadLoanForm() {
                try {
                    ...
                    html2pdf().from(element).set(opt).save().then(() => {
                        console.log('Loan Form Downloaded successfully');
                    }).catch(err => {
                        console.error('PDF Error:', err);
                        alert('Failed to generate PDF: ' + err.message);
                    });
