<%@ Page Title="Announcement" Language="C#" MasterPageFile="~/webpage(PresidentViewpoint)/President.Master"
    AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="ExWebAppSia.webpage_PresidentViewpoint_.Announcement"
    %>
        ...
        <div class="container-box">
            ...
            <div class="create-panel">
                <div class="create-header">
                    ...
                    <textarea id="txtAnnouncement" class="create-input" placeholder="What's on your mind, Executive?"
                ...
                container.innerHTML = filtered.map(ann => `
                    <div class="announcement-card ${ann.IsPinned ? 'pinned-mode' : ''}">
                        ...
                        <div class="card-header">
                            <div class="poster-avatar">${(ann.PostedBy || 'E').charAt(0)}</div>
                            <div class="poster-info">
                                <h4>${ann.PostedBy || 'Executive'}</h4>
