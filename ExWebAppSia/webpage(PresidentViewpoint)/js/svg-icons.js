/* ============================================
   SVG ICON LIBRARY - ESSENTIALS BEAUTY HR
...
const SvgIcons = {
    ...
    chartLine: `
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M3 3v18h18M7 15l4-4 4 4 6-6" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    `,
...
function getIcon(iconName, className = '') {
    if (SvgIcons[iconName]) {
        return SvgIcons[iconName].replace('<svg', `<svg class="${className}"`);
    }
    return '';
}
...
function createIconElement(iconName, className = '') {
    ...
    tempDiv.innerHTML = getIcon(iconName, className);
