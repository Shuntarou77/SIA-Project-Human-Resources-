    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="resignationRequestModal" class="page-modal">
            <div class="modal-content" style="max-width: 600px;">
                ...
                <div class="modal-body" style="padding: 24px;">
                    ...
                    <div id="resignationFormGroup">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="txtResignationReason" class="form-textarea" placeholder="I am writing to formally resign from my position..."></textarea>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-cancel" onclick="closeModal('resignationRequestModal')">Cancel</button>
                    <button id="btnConfirmResignation" type="button" class="btn-submit" style="background: #ef4444;" onclick="submitResignationRequest()">Submit Request</button>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            async function submitResignationRequest() {
                ...
                if (!lastDay) {
                    showRestrictionModal('Please select your effective last day.', 'Required Field');
                    return;
                }
                if (!reasonCode) {
                    showRestrictionModal('Please select a reason code.', 'Required Field');
                    return;
                }
                if (!reason) {
                    showRestrictionModal('Please provide a comment for your resignation.', 'Required Field');
                    return;
                }

                const confirmRes = await Swal.fire({
                    title: 'Confirm Resignation',
                    text: 'Are you sure you want to submit your resignation request? This is a formal action.',
                    icon: 'warning',
                ...
                if (confirmRes.isConfirmed) {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            openSuccessModal('Your resignation request has been submitted successfully! One of our HR personnel will review it shortly.');
                            setTimeout(() => { window.location.reload(); }, 3000);
                        } else {
                            showRestrictionModal(result.message || 'Failed to submit request.', 'Submission Error');
                            btn.disabled = false;
