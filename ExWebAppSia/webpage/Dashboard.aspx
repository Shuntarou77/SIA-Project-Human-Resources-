                        ...
                        <div class="large-card">
                            ...
                            <div class="chart-container">
                                    ...
                                    <div class="bar-wrapper">
                                        <div class="chart-fill" style="height: <asp:Literal ID="litRegularPercentage" runat="server" Text="0"></asp:Literal>%;">
                                            <span class="chart-value">
                                                <asp:Literal ID="litRegularPercentageDisplay" runat="server" Text="0%">
                                                </asp:Literal>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="chart-bar chart-contractual">
                                    <div class="bar-wrapper">
                                        <div class="chart-fill" style="height: <asp:Literal ID="litContractualPercentage" runat="server" Text="0"></asp:Literal>%;">
                                            <span class="chart-value">
